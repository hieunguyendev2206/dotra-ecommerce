...
const ProductList = ({styles, products}) => {
        ...
        >
            {products.map((p) => (
                ...
                >
                    ...
                    >
                        <img
                            className="w-full h-full object-contain rounded-t-md" // Hiển thị đầy đủ hình ảnh
                            style={{aspectRatio: "1 / 1", objectPosition: "center"}} // Duy trì tỷ lệ và căn giữa

...
import {message_clear, seller_register,} from "../../../store/reducers/auth.reducers";
...
const Register = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row justify-center min-h-screen font-sans bg-white">
            <div className="hidden md:block w-1/2 bg-center bg-cover bg-hero-pattern"></div>
            <div className="flex-1 mx-auto max-w-full p-4 md:max-w-2xl">
                <div className="flex flex-col px-8 pt-10 md:px-14 xl:px-24">

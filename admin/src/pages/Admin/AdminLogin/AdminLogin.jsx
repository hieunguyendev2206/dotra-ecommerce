...
import {admin_login, message_clear,} from "../../../store/reducers/auth.reducers";
...
const AdminLogin = () => {
    const {
        FcGoogle, FaFacebook, AiOutlineMail, AiOutlineEye, AiOutlineEyeInvisible, FiLock,
    } = icons;
    const [visible, setVisible] = useState(false);
    const dispatch = useDispatch();
    const navigate = useNavigate();
    const {loading, success_message, error_message} = useSelector((state) => state.auth);
    ...
    const handleInput = (event) => {
        ...
        setState({
            ...state, [formData]: event.target.value,
        });
    };
    ...
    return (<div className="flex items-center min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
        <div
            ...
            <div className="flex flex-col overflow-y-auto md:flex-row">
                <div className="h-32 md:h-auto md:w-1/2 bg-cover bg-center bg-login-pattern lg:block"></div>
                <main className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div className="w-full">
                        ...
                        <div className="gap-y-4 gap-x-6 justify-center items-center pt-5 whitespace-nowrap">
                            <button
                                className="flex w-full items-center justify-center mb-4 flex-1 py-3 px-2 rounded-lg bg-white border border-gray-400 whitespace-nowrap hover:bg-gray-50 focus:outline-none focus:ring-gray-100 focus:ring-4">
                            ...
                            <button
                                className="flex w-full items-center justify-center flex-1 py-3 px-2 rounded-lg bg-blue-500 whitespace-nowrap hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-gray-100">
